 ...
 */
final class Version20220616174312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE competence (id INT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE employe (id INT NOT NULL, compte_id INT DEFAULT NULL, nni INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, email VARCHAR(255) NOT NULL, telephone INT NOT NULL, date_recrutement DATE DEFAULT NULL, matricule VARCHAR(255) DEFAULT NULL, fonction VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, domaine VARCHAR(255) DEFAULT NULL, photo BYTEA DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F804D3B9F2C56620 ON employe (compte_id)');
        $this->addSql('CREATE TABLE experience (id INT NOT NULL, entreprise VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE DEFAULT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE langue (id INT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
